...
namespace Rotativa.Extensions
{
    public class ViewAsPdfByteWriter : ViewAsPdf
    {
        ...
        //public void ViewAsPdfByteWriterText(string viewName, object model, bool addPaging = false, string footerText = null)
        //{
        //    PageOrientation = Orientation.Portrait;
        //    //PageMargins = new Margins(20, 20, 10, 30);
        //    PageSize = Size.A4;
        ...
        //    this.CustomSwitches = "--disable-smart-shrinking --margin-top 16mm --margin-right 12mm  --margin-left 25mm";
        //    if (addPaging || !string.IsNullOrEmpty(footerText))
        //    {
        //        this.CustomSwitches += " --margin-bottom 20mm --page-offset 0  --encoding utf-8";
        ...
        //                pageInfo = "; стр.[page]";
        //            }
        //            this.CustomSwitches += $" --margin-bottom 20mm --page-offset 0 --footer-center \"{footerText}{pageInfo}\" ";
        //        }
        //        else
        //        {
        //            if (addPaging)
