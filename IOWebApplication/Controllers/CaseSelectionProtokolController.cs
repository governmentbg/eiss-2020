    ...
    public class CaseSelectionProtokolController : BaseController
    {
        ...
        public IActionResult Edit(CaseSelectionProtokolVM model)
        {
            ...
            else
            {
                ...
                //logger.LogCritical($"CaseSelectionProtokol_SaveData done  {DateTime.Now.ToString("mm: ss.FFF")}");
                ///////////////Denislav Angelov 2020.08.27
                //}
                //else
                //{
        ...
        public IActionResult LawUnits_LoadByDuty(int courtDutyId, int caseId, int judgeRoleId)
        {
            ViewBag.RoleId = NomenclatureConstants.JudgeRole.JudgeReporter;
            var model = service.LawUnit_LoadByCourtDutyId(courtDutyId, caseId, userContext.CourtId, judgeRoleId);
        ...
        public IActionResult CaseSelectionProtokolList()
        {
            ...
            ViewBag.ProtokolState_ddl = new List<SelectListItem>()
              {
                  new SelectListItem("Подписан",NomenclatureConstants.SelectionProtokolState.Signed.ToString()),
                  new SelectListItem("Неподписан",NomenclatureConstants.SelectionProtokolState.Generated.ToString())
              };
            ...
            ViewBag.CourtGroupIds_ddl = nomService.GetDDL_CourtGroup(userContext.CourtId, false);
            ViewBag.LoadGroupLinkIds_ddl = nomService.GetDDL_LoadGroupLink(false);
