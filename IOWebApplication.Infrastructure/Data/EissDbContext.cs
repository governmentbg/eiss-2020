...
{
    public class EissDbContext : DbContext, IDataProtectionKeyContext
    {

        public EissDbContext(DbContextOptions<EissDbContext> options)
            : base(options)
        {
        ...
        protected EissDbContext(DbContextOptions options)
        : base(options)
        {
            //Disabling Lazy Loading
            this.ChangeTracker.LazyLoadingEnabled = false;
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<CourtGroup>()
                .Property(p => p.GroupKind)
                .HasDefaultValueSql("1");

            builder.Entity<CaseSessionActCoordination>()
                .Property(p => p.CoordinationType)
                .HasDefaultValueSql("1");

            builder.Entity<CaseLawUnit>()
                .Property(p => p.SavedOrderBy)
          ...
          .HasKey(x => new { x.ExecListLawBaseId, x.CaseGroupId });
            ...
            builder.Entity<MainGroup>()
                .HasOne(e => e.LastTransation)
                .WithOne(e => e.MainGroupLastTransaction);


            builder.Entity<CaseFeatureCourtType>()
                .HasKey(x => new { x.CaseFeatureId, x.CourtTypeId });
            builder.Entity<CaseFeatureType>()
               .HasKey(x => new { x.CaseFeatureId, x.CaseTypeId });
            builder.Entity<CaseFeatureCode>()
                   .HasKey(x => new { x.CaseFeatureId, x.CaseCodeId });

            builder.Entity<GetCounterValueVM>()
                .HasNoKey();
            builder.Entity<ReportCourtStatsVM>()
                .HasNoKey();
            builder.Entity<ReportCourtGenericVM>()
                .HasNoKey();
            builder.Entity<UpdateDateTransferedVM>()
                .HasNoKey();

            builder.Entity<FastProcessSelectionCourt>()
                .HasKey(x => new { x.Id, });
            builder.Entity<FastProcessSelectionCourt>()
            .HasOne(x => x.Court);

            builder.Entity<BankCodePaymentType>()
                       .Property(e => e.BankCodes)
                       .HasColumnType("jsonb")
                       .HasConversion(v => JsonSerializer.Serialize(v, (JsonSerializerOptions)null),
                                      v => JsonSerializer.Deserialize<List<string>>(v, (JsonSerializerOptions)null));

            builder.Entity<CounterCheck>()
                .HasKey(x => new { x.SourceType, x.CouterValue });
        }

        #endregion


        //DbQuery няма - само DbSet. да се махат от миграциите!!!!
        public DbSet<GetCounterValueVM> GetCounterValueVM { get; set; }
        public DbSet<ReportCourtStatsVM> ReportCourtStatsVM { get; set; }
        public DbSet<ReportCourtGenericVM> ReportCourtGenericVM { get; set; }
        public DbSet<UpdateDateTransferedVM> UpdateDateTransferedVM { get; set; }
        ...
        public DbSet<CaseLawyerHelpAssignedLawyer> CaseLawyerHelpAssignedLawyers { get; set; }
        ...
        public DbSet<CaseNotificationDocument> CaseNotificationDocuments { get; set; }
        ...
        public DbSet<CasePersonSentencePunishmentMeasure> CasePersonSentencePunishmentMeasure { get; set; }
        public DbSet<CasePersonPrevName> CasePersonPrevName { get; set; }
        ...
        public DbSet<CaseSelectionProtokolSubstitution> CaseSelectionProtokolSubstitution { get; set; }
        public DbSet<CaseSelectionProtokolSubstitutionLawUnit> CaseSelectionProtokolSubstitutionLawUnit { get; set; }
        public DbSet<CaseSelectionSubstitution> CaseSelectionSubstitutions { get; set; }
        ...
        public DbSet<CaseSessionActCorrection> CaseSessionActCorrections { get; set; }
        public DbSet<CaseSessionActLawBase> CaseSessionActLawBases { get; set; }
        public DbSet<CaseSessionActLawunit> CaseSessionActLawunits { get; set; }
        public DbSet<CaseSessionActSelectionProtokol> CaseSessionActSelectionProtokol { get; set; }
        public DbSet<CaseSessionActSelectionProtocolAct> CaseSessionActSelectionProtocolAct { get; set; }
        ...
        public DbSet<MediationCaseMediator> MediationCaseMediators { get; set; }
        public DbSet<MediationCaseMediatorAppraisal> MediationCaseMediatorAppraisals { get; set; }
        public DbSet<MediationCaseMediatorAppraisalData> MediationCaseMediatorAppraisalDatas { get; set; }
        public DbSet<MediationCasePerson> MediationCasePeople { get; set; }
        public DbSet<MediationCaseSession> MediationCaseSessions { get; set; }
        public DbSet<MediationCaseSessionResult> MediationCaseSessionResults { get; set; }
        public DbSet<MediationCaseSessionDocument> MediationCaseSessionDocuments { get; set; }
        public DbSet<MediationCaseSessionLinkCase> MediationCaseSessionLinkCases { get; set; }
        public DbSet<CaseSessionActPeriodNotification> CaseSessionActPeriodNotifications { get; set; }

        public DbSet<CaseSimilarCase> CaseSimilarCases { get; set; }
        ...
        public DbSet<CounterCheck> CounterChecks { get; set; }
        ...
        public DbSet<CourtLawUnitAssistant> CourtLawUnitAssistants { get; set; }
        ...
        public DbSet<CourtRestriction> CourtRestrictions { get; set; }

        public DbSet<CourtStampCertificate> CourtStampCertificates { get; set; }
        ...
        public DbSet<LawUnitTemplate> LawUnitTemplate { get; set; }
        ...
        public DbSet<FilterTemplates> FilterTemplates { get; set; }
        public DbSet<FastProcessSelectionCourt> FastProcessSelectionCour { get; set; }

        public DbSet<MediationCenter> MediationCenters { get; set; }
        public DbSet<MediationCenterCourt> MediationCenterCourts { get; set; }
        public DbSet<MediationCoordinator> mediationCoordinators { get; set; }
        public DbSet<MediationCoordinatorCenter> MediationCoordinatorCenters { get; set; }
        public DbSet<MediationMediator> MediationMediators { get; set; }
        public DbSet<MediationMediatorCenter> MediationMediatorCenters { get; set; }
        public DbSet<MediatorFee> MediatorFees { get; set; }
        ...
        public DbSet<DeliveryItemOperLog> DeliveryItemOperLog { get; set; }
        #endregion
        ...
        public DbSet<ElectionGroup> ElectionGroup { get; set; }
        public DbSet<ElectionPerson> ElectionPerson { get; set; }
        public DbSet<ElectionProtocol> ElectionProtocol { get; set; }
        public DbSet<ElectionLog> ElectionLog { get; set; }
        public DbSet<ElectionPersonState> ElectionPersonState { get; set; }
        public DbSet<ElectionPersonDismissalType> ElectionPersonDismissalType { get; set; }
        ...
        public DbSet<DocumentRequestInfo> DocumentRequestInfos { get; set; }
        public DbSet<ElectronicDocument> ElectronicDocuments { get; set; }
        public DbSet<ElectronicDocumentPerson> ElectronicDocumentPersons { get; set; }
        ...
        public DbSet<BankFilePayment> BankFilePayments { get; set; }
        ...
        public DbSet<BlankTemplate> BlankTemplates { get; set; }
        public DbSet<BlankTemplateLink> BlankTemplateLinks { get; set; }
        ...
        public DbSet<CaseCodeSub> CaseCodeSubs { get; set; }
        public DbSet<CaseGroup> CaseGroups { get; set; }
        public DbSet<CaseFeature> CaseFeatures { get; set; }
        public DbSet<CaseFeatureCourtType> CaseFeatureCourtTypes { get; set; }
        public DbSet<CaseFeatureType> CaseFeatureTypes { get; set; }
        public DbSet<CaseFeatureCode> CaseFeatureCodes { get; set; }
        ...
        public DbSet<CaseSelectionChange> CaseSelectionChanges { get; set; }
        ...
        public DbSet<EesppLawyerState> EesppLawyerStates { get; set; }
        public DbSet<EesppPersonState> EesppPersonStates { get; set; }
        ...
        public DbSet<FastProcess417CompetencyBase> FastProcess417CompetencyBases { get; set; }
        public DbSet<FastProcessClaimCircumstance> FastProcessClaimCircumstances { get; set; }
        public DbSet<FastProcessClaimCircumstanceGroup> FastProcessClaimCircumstanceGroups { get; set; }
        public DbSet<FastProcessExpenseType> FastProcessExpenseTypes { get; set; }
        public DbSet<FastProcessMoneyClaimType> FastProcessMoneyClaimTypes { get; set; }
        ...
        public DbSet<IspnCaseCompetence> IspnCaseCompetences { get; set; }
        ...
        public DbSet<MongoFileType> MongoFileTypes { get; set; }
        public DbSet<MongoFileTypeGrouping> MongoFileTypeGroupings { get; set; }
        ...
        public DbSet<TransactionOperationType> TransactionOperationTypes { get; set; }
        ...
        public DbSet<MoneyTypeGrouping> MoneyTypeGroupings { get; set; }

        public DbSet<SismaIndexRecap> SismaIndexRecaps { get; set; }

        public DbSet<SismaIndexRecapContains> IndexRecapContains { get; set; }

        public DbSet<ExcelSismaMapping> ExcelSismaMappings { get; set; }
        public DbSet<FilterTemplateType> FilterTemplateTypes { get; set; }

        public DbSet<PunishmentGeneralCategory> PunishmentGeneralCategories { get; set; }
        public DbSet<CategoryDeed> CategoryDeeds { get; set; }
        public DbSet<CategoryCommonDeed> CategoryCommonDeeds { get; set; }
        public DbSet<ActISPNReasonGrouping> ActISPNReasonGroupings { get; set; }
        public DbSet<BankFilePaymentTypeCode> BankFilePaymentTypeCodes { get; set; }
        public DbSet<BankFilePaymentType> BankFilePaymentTypes { get; set; }
        public DbSet<BankCodePaymentType> BankCodePaymentTypes { get; set; }

        public DbSet<MediationLocation> MediationLocations { get; set; }
        public DbSet<MediationPointMediatorAppraisal> MediationPointMediatorAppraisals { get; set; }
        public DbSet<MediationResult> MediationResults { get; set; }
        public DbSet<MediationResultBase> MediationResultBases { get; set; }
        public DbSet<MediationResultGroup> MediationResultGroups { get; set; }
        public DbSet<MediationState> MediationStates { get; set; }
        public DbSet<MediationType> MediationTypes { get; set; }
        public DbSet<MediationPersonSessionState> MediationPersonSessionStates { get; set; }
        public DbSet<MediationProcedure> MediationProcedures { get; set; }
        public DbSet<MediationTypeChoiceMediator> MediationTypeChoiceMediators { get; set; }
        ...
        public DbSet<EisppEktteCode> EisppEktteCode { get; set; }
        #endregion
