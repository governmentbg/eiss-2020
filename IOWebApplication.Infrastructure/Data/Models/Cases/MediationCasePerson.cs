...
{
    /// <summary>
    /// Страни по делото за срещата
    /// </summary>
    [Table("mediation_case_person")]
    [Comment("Страни по делото за срещата")]
    public class MediationCasePerson : UserDateWRT, IExpiredInfo
    {
        /// <summary>
        ...
        /// <summary>
        /// Идентификатор на страна от делото
        /// </summary>
        ...
        public virtual CasePerson Person { get; set; }

        /// <summary>
        /// Статус на лицето след срещата - присъства и т.н.
        /// </summary>
        [ForeignKey(nameof(MediationPersonSessionStateId))]
        public virtual MediationPersonSessionState State { get; set; }
