...
{
    /// <summary>
    /// Съобщение/призовки/уведомяване към Среща по дело - медиация
    /// </summary>
    [Table("mediation_notification")]
    public class MediationNotification : BaseInfo_MediationNotification, IExpiredInfo
    {
        ...
        public virtual ICollection<MediationNotificationMLink> MediationNotificationMLinks { get; set; }
    ...
    public class BaseInfo_MediationNotification : UserDateWRT
    {
        [Column("id")]
        ...
        public long? CasePersonAddressId { get; set; }
