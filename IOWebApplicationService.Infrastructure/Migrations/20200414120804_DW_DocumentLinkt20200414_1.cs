...
{
    public partial class DW_DocumentLinkt20200414_1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "dw_document_link",
                columns: table => new
                {
                    ...
                    document_direction_id = table.Column<int>(nullable: true),
                    document_direction_name = table.Column<string>(nullable: true),
                    prev_document_id = table.Column<long>(nullable: true),
                    prev_document_number = table.Column<string>(nullable: true),
                    prev_document_date = table.Column<DateTime>(nullable: true),
                    description = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dw_document_link", x => x.dw_Id);
                });
        }
